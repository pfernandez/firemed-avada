												...
												<table>
													<tbody>
														...
														<tr>
															<td><?php _e('Other options', 'LayerSlider') ?></td>
															<td class="right"><?php _e('Distance', 'LayerSlider') ?></td>
															<td><input type="text" name="level" value="<?php echo $sublayer['level'] ?>" data-help="<?php _e('The default value is -1 which means that the layer will be positioned exactly outside the of slide container. You can use the default setting in most of the cases. If you need to set the start or end position of the layer from further of the edges of the slide container, you can use 2, 3 or higher values.', 'LayerSlider') ?>"></td>
															<td class="right"><?php _e('Show until', 'LayerSlider') ?></td>
															...
															<td colspan="3"><button class="button duplicate" data-help="<?php _e('If you will use similar settings for other layers or you want to experiment on a copy, you can duplicate this layer.', 'LayerSlider') ?>"><?php _e('Duplicate this sublayer', 'LayerSlider') ?></button></td>
														</tr>
												</table>
											</div>
											<div class="ls-sublayer-page ls-sublayer-link">
												...
												<table>
													<tbody>
														...
														<tr>
															...
															<td class="right"><?php _e('Color', 'LayerSlider') ?></td>
															<td><input type="text" name="color" class="auto" value="<?php echo isset($sublayer['styles']['color']) ? $sublayer['styles']['color'] : '' ?>" data-help="<?php _e('The color of your text. You can use color names, hexadecimal, RGB or RGBA values. Example: #333', 'LayerSlider') ?>"></td>
														</tr>
														<tr>
															<td><?php _e('Misc', 'LayerSlider') ?></td>
															<td class="right"><?php _e('Background', 'LayerSlider') ?></td>
															<td><input type="text" name="background" class="auto" value="<?php echo isset($sublayer['styles']['background']) ? $sublayer['styles']['background'] : '' ?>" data-help="<?php _e("The background color of your layer. You can use color names, hexadecimal, RGB or RGBA values as well as the 'transparent' keyword. Example: #FFF", "LayerSlider") ?>"></td>
															<td class="right"><?php _e('Rounded corners', 'LayerSlider') ?></td>
