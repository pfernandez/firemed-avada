	...
	<footer class="footer-area">
        ...
        <?php if ( is_active_sidebar( 'Avada Footer Widget 1' ) ) : ?>
				<article class="col">
				<?php
				if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('Avada Footer Widget 1')):
				endif;
				?>
				</article>
        <?php endif; ?>

        <?php if ( is_active_sidebar( 'Avada Footer Widget 2' ) ) : ?>
				<article class="col">
				<?php
				if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('Avada Footer Widget 2')):
				endif;
				?>
				</article>
        <?php endif; ?>

        <?php if ( is_active_sidebar( 'Avada Footer Widget 3' ) ) : ?>
				<article class="col">
				<?php
				if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('Avada Footer Widget 3')):
				endif;
				?>
				</article>
        <?php endif; ?>

        <?php if ( is_active_sidebar( 'Avada Footer Widget 4' ) ) : ?>
				<article class="col last">
				<?php
				if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('Avada Footer Widget 4')):
				endif;
				?>
				</article>
        <?php endif; ?>
