...
<script id="template-familyMemberRow" type="template/html">
  <div class="member">
    <label>
      <input type="text" maxlength="100" autocomplete="off" name="s2member_pro_paypal_checkout[custom_fields][family_members][<%=id %>][first_name]" class="member-first-name" />
    </label>
    <label>
      <input type="text" maxlength="100" autocomplete="off" name="s2member_pro_paypal_checkout[custom_fields][family_members][<%=id %>][middle_initial]" class="member-middle-initial" />
    </label>
    <label>
      <input type="text" maxlength="100" autocomplete="off" name="s2member_pro_paypal_checkout[custom_fields][family_members][<%=id %>][last_name]" class="member-last-name" />
    </label>
    <label>
      <input type="text" maxlength="100" autocomplete="off" name="s2member_pro_paypal_checkout[custom_fields][family_members][<%=id %>][dob]" class="member-dob" />
    </label>
...
<form id="s2member-pro-paypal-checkout-form" class="s2member-pro-paypal-form s2member-pro-paypal-checkout-form" method="post" action="%%action%%" novalidate="novalidate">
  <div id="accordion">
    ...
    <div id="step2">
      <h1 class="pane-title">Step 2: Promotional Code</h1>
      <p>If you have a student or business code, please enter it below, or skip to Step 3.</p>
      <div id="step2-pane" class="pane" style="%%membership_level_selected%%">
        ...
        <label for="s2member-pro-paypal-checkout-coupon" id="s2member-pro-paypal-checkout-form-coupon-label" class="s2member-pro-paypal-form-coupon-label s2member-pro-paypal-checkout-form-coupon-label">
          <span><?php echo _x ("Promo Code", "s2member-front", "s2member"); ?></span>
    ...
    <div id="step3">
      ...
      <div id="step3-pane" class="pane">
        <div id="contact-section" class="form-section">
          <div class="one_half">
            <label for="home-address-street">
              ...
              <input required="required" type="text" aria-required="true" autocomplete="off" name="s2member_pro_paypal_checkout[custom_fields][home_address_street]" id="home-address-street" class="" value="%%home_address_street_value%%" tabindex="" />
            </label>

            <div class="avada-row">
              <label for="home-address-city">
                <span>City</span>
                <input required="required" type="text" aria-required="true" autocomplete="off" name="s2member_pro_paypal_checkout[custom_fields][home_address_city]" id="home-address-city" class="" value="%%home_address_city_value%%" tabindex="" />
              </label>
            ...
            <label for="mailing-same-as-home">
              <input type="checkbox" aria-required="false" autocomplete="off" name="s2member_pro_paypal_checkout[custom_fields][mailing_same_as_home]" id="mailing-same-as-home" class="" value="%%mailing_same_as_home%%" tabindex="" />
              <span>Check if your mailing address is the same as your home address</span>
            </label>

            <label for="email">
              <span>Email Address</span>
              <input required="required" type="email" required="required" aria-required="true" data-expected="email" maxlength="100" autocomplete="off" name="s2member_pro_paypal_checkout[email]" id="email" value="%%email_value%%" tabindex="" />
            </label>

            <label for="phone">
              <span>Phone Number</span>
              <input required="required" type="text" aria-required="true" autocomplete="off" name="s2member_pro_paypal_checkout[custom_fields][phone]" id="phone" class="" value="%%phone_value%%" tabindex="" />
            </label>
          </div>

          <div class="one_half last">
            <label for="mailing-address-street">
              <span>Mailing Address</span>
              <input required="required" type="text" aria-required="true" autocomplete="off" name="s2member_pro_paypal_checkout[custom_fields][mailing_address_street]" id="mailing-address-street" class="" value="%%mailing_address_street_value%%" tabindex="" />
            </label>

            <div class="avada-row">
              <label for="mailing-address-city">
                <span>City</span>
                <input required="required" type="text" aria-required="true" autocomplete="off" name="s2member_pro_paypal_checkout[custom_fields][mailing_address_city]" id="mailing-address-city" class="" value="%%mailing_address_city_value%%" tabindex="" />
              </label>
              <label for="mailing-address-state">
                <span>State</span>
                %%mailing_address_state%%
              </label>
              <label for="mailing-address-zip">
                <span>Zip Code</span>
                <input required="required" type="text" aria-required="true" autocomplete="off" name="s2member_pro_paypal_checkout[custom_fields][mailing_address_zip]" id="mailing-address-zip" class="" value="%%mailing_address_zip_value%%" tabindex="" />
              </label>
            </div>
        ...
        <div id="family-section" class="form-section">
          <p>Please print your name (first, middle initial and last) and the names of all household members to be covered under this membership.</p>

          <!-- First member = this user. -->
          <div class="member">
            <label>
              <span>First Name</span>
              <input required="required" type="text" aria-required="true" maxlength="100" autocomplete="off" name="s2member_pro_paypal_checkout[first_name]" class="member-first-name" value="%%first_name_value%%" />
            </label>
            <label>
              <span>M. I.</span>
              <input required="required" type="text" aria-required="true" maxlength="100" autocomplete="off" name="s2member_pro_paypal_checkout[custom_fields][member_middle_initial]" class="member-middle-initial" value="%%member_middle_initial_value%%" />
            </label>
            <label>
              <span>Last Name</span>
              <input required="required" type="text" aria-required="true" maxlength="100" autocomplete="off" name="s2member_pro_paypal_checkout[last_name]" class="member-last-name" value="%%last_name_value%%"  />
            </label>
            <label>
              <span>Date of Birth (mm/dd/yyyy)</span>
              <input required="required" type="text" aria-required="true" maxlength="100" autocomplete="off" name="s2member_pro_paypal_checkout[custom_fields][member_dob]" class="member-dob" value="%%member_dob_value%%" />
    ...
    <div id="step4">
      ...
      <div id="step4-pane" class="pane">
        <div class="one_half">
          <div class="card-type-label">Select your card type:</div>
          ...
          <div id="billing-address-section" class="form-section">
            <label for="billing-address-street">
              ...
              <input required="required" type="text" aria-required="true" maxlength="100" autocomplete="off" name="s2member_pro_paypal_checkout[street]" id="billing-address-street" value="%%street_value%%" tabindex="" />
            </label>
            <div class="avada-row">
              <label for="billing-address-city">
                <span>City</span>
                <input required="required" type="text" aria-required="true" maxlength="100" autocomplete="off" name="s2member_pro_paypal_checkout[city]" id="billing-address-city" value="%%city_value%%" tabindex="" />
              </label>
              ...
              <label for="billing-address-zip">
                <span>Zip Code</span>
                <input required="required" type="text" aria-required="true" maxlength="100" autocomplete="off" name="s2member_pro_paypal_checkout[zip]" id="billing-address-zip" value="%%zip_value%%" tabindex="" />
              </label>
            </div>
          ...
          <div id="billing-method-section" class="form-section">
            ...
            <label for="billing-method-card-number">
              ...
              <input required="required" type="text" aria-required="true" maxlength="100" autocomplete="off" name="s2member_pro_paypal_checkout[card_number]" id="billing-method-card-number" value="%%card_number_value%%" tabindex="" />
            </label>
              <label for="billing-method-card-cvv">
                ...
                <input required="required" type="text" aria-required="true" maxlength="100" autocomplete="off" name="s2member_pro_paypal_checkout[card_verification]" id="billing-method-card-cvv" value="%%card_verification_value%%" tabindex="" />
              </label>
              <label for="billing-method-card-expiration">
              <span>Exp Date (mm/yyyy)</span>
              <input required="required" type="text" aria-required="true" maxlength="100" autocomplete="off" name="s2member_pro_paypal_checkout[card_expiration]" id="billing-method-card-expiration" value="%%card_expiration_value%%" tabindex="" />
            </label>
            </div>
            <div style="clear:both;"></div>
        ...
        <div id="form-submission-section">
          <div id="form-submit">
            ...
            <div class="form-response">%%response%%</div>
          </div>
          <div style="clear:both;"></div>
        </div>
      </div><!-- end .pane -->
